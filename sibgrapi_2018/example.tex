...
\twocolumn[{%
	...
	\captionof{figure}{Example of automatic scene conversion obtained with our system. \textit{Coffee Maker} originally modeled for PBRT v3 (left). Rendering produced by Mitsuba (center) and LuxRender (right), from converted scenes for these rendering systems.}
	\label{fig:teaser}
	\end{center}%
}]	
