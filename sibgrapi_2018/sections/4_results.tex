...
\begin{figure}
	\centering
	\subfloat[PBRT v3]{\includegraphics[width=0.32\linewidth]{figs/4_results/veach-mis/1_from_pbrt.png}
		\label{glass_PBRT}		
	}	
	\subfloat[Mitsuba]{\includegraphics[width=0.32\linewidth]{figs/4_results/veach-mis/2_to_mitsuba.png}
		\label{glass_Mitsuba}		
	}	
	\subfloat[LuxRender]{\includegraphics[width=0.32\linewidth]{figs/4_results/veach-mis/3_to_lux.png}
		\label{glass_Lux}		
	}	
