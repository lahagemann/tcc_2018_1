...
%Some difference between the rendered images is expected, especially of scenes with environment emitters. All three renderers have different implementations of sun and sky directives, Mitsuba being the 
