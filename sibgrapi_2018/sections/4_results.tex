...
\begin{figure*}[t!bp]
	...
	\begin{tabular}{@{}r@{ } c@{ } c@{ } c@{ } c }
		...
		\small{Diff from converted$_1$} &
		\small{Diff from converted$_2$} &
		\small{Diff between converted} \\
		...
		\subfloat[PBRT -- Mitsuba]{\includegraphics[width=0.15\textwidth]{figs/4_results/coffee/diff_pbrt-mitsuba.png}} &
		\subfloat[PBRT -- LuxRender]{\includegraphics[width=0.15\textwidth]{figs/4_results/coffee/diff_pbrt-lux.png}} &
		\subfloat[Mitsuba -- Lux]{\includegraphics[width=0.15\textwidth]{figs/4_results/coffee/diff_mitsuba-lux.png}} \\
