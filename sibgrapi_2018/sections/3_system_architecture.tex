...
Our system should provide an output scene representation which, once rendered with the target system, best approximates the results obtained by the source rendering system with the input scene description.  
