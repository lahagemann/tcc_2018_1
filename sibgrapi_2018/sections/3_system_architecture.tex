...
\red{The \textbf{texture} directive is represented in a structure with: a type, an id and a list of parameters. [Not shown in Fig. 2]}
...
\red{This essentialy means that} <>