...
%	    	Glass of Water \small{(P)}& 14.65 \small{(P,L)} & 13.84 \small{(P,M)} & 37.05 \small{(P)} \\
...
%    \end{tabular}
\end{center}
  \caption{PSNR values for images rendered from scene descriptions automatically converted by our tool to two target systems. 
  	The reference images were obtained by rendering the input scenes with the source systems shown on the left. 
  	For comparison, the right column shows the PSNR of an additional rendition of the input scene produce by the source system.
