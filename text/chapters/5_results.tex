...
\begin{figure*}
  \centering
  \subfloat[LuxRender]{\includegraphics[width=0.6\linewidth]{images/5_results/teapot/1_from_lux.png}\label{teapot_Lux}}\\
  \subfloat[PBRT v3]{\includegraphics[width=0.6\linewidth]{images/5_results/teapot/3_to_pbrt.png}\label{teatpot_PBRT}}\\
  \subfloat[Mitsuba]{\includegraphics[width=0.6\linewidth]{images/5_results/teapot/2_to_mitsuba.png}\label{teapot_Mitsuba}}
...
\begin{figure*}
  \centering
  \subfloat[LuxRender]{\includegraphics[width=0.5\linewidth]{images/5_results/dining_room/1_from_lux.png}\label{breakfast_Lux}}\\
  \subfloat[PBRT v3]{\includegraphics[width=0.5\linewidth]{images/5_results/dining_room/3_to_pbrt.png}\label{breakfast_PBRT}}\\
  \subfloat[Mitsuba]{\includegraphics[width=0.5\linewidth]{images/5_results/dining_room/2_to_mitsuba.png}\label{breakfast_Mitsuba}}
...
\begin{figure}
  \centering
  \subfloat[PBRT v3]{\includegraphics[width=0.6\linewidth]{images/5_results/veach-mis/1_from_pbrt_s.png} \label{MIS_PBRT}}\\
  \subfloat[Mitsuba]{\includegraphics[width=0.6\linewidth]{images/5_results/veach-mis/2_to_mitsuba_s.png}\label{MIS_Mitsuba}}\\
  \subfloat[LuxRender]{\includegraphics[width=0.6\linewidth]{images/5_results/veach-mis/3_to_lux_s.png}\label{MIS_Lux}}
