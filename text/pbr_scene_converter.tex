...
% - why is it important? diffusion of rendering across many fields, such as movies, games, design, etc
...
% - the creation of renderers for the market
...
% - stating the problem/motivation: making scenes is hard (reference: http://www.laubwerk.com/home/)
...
renderer's limitations and particularities. %Crafting such scenes is an onerous, time-consuming effort: so much that 
...
% - render toolbox4 (https://github.com/RenderToolbox/RenderToolbox4/wiki/Overview)
